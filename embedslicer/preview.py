...
from .smoothing import smooth_polygon  # noqa: E402
from .toolpath import generate_perimeters  # noqa: E402


def render(plan, layers, out_path, line_width=0.4, perimeters=2, smoothing=0.0):
    ...
    for gi, group in enumerate(plan):
        ...
        for li, ii in group:
            ...
            if smoothing > 0:
                polygon = smooth_polygon(polygon, smoothing)
